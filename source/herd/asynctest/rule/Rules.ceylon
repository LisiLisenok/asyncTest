...
{
	"Test callback which is called _once_ before all tests within the scope
	...
	"Test callback which is called _once_ after all tests within the scope
...
{
	"Test callback which is called before _each_ test function within the scope
	...
	"Test callback which is called after _each_ test function within the scope
	 (package for top-level value or class for attribute) is executed."
